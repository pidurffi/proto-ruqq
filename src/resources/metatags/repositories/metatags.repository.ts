...
import { MetatagsQueryDto } from '../dto/metatags.dto'
import { PaginationDto } from '../../../common'

@Injectable()
export class MetatagsRepository extends Repository<Metatags> {
  constructor(@Inject(repositories.METATAGS_REPOSITORY) private readonly _: Repository<Metatags>) {
    super(_.target, _.manager, _.queryRunner)
  }

  async findByFiltersPaginated(payload: MetatagsQueryDto) {
