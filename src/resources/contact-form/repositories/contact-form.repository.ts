...
import { ContactFormQueryDto } from '../dto/contact-form.dto'
import { PaginationDto } from '../../../common'

@Injectable()
export class ContactFormRepository extends Repository<ContactForm> {
  constructor(@Inject(repositories.CONTACTFORM_REPOSITORY) private readonly _: Repository<ContactForm>) {
    super(_.target, _.manager, _.queryRunner)
  }

  async findByFiltersPaginated(payload: ContactFormQueryDto) {
