...
import { RoomEquipmentQueryDto } from '../dto/room-equipment.dto'
import { PaginationDto } from '../../../common'

@Injectable()
export class RoomEquipmentRepository extends Repository<RoomEquipment> {
  constructor(@Inject(repositories.ROOMEQUIPMENT_REPOSITORY) private readonly _: Repository<RoomEquipment>) {
    super(_.target, _.manager, _.queryRunner)
  }

  async findByFiltersPaginated(payload: RoomEquipmentQueryDto) {
